...
const Footer = () => {
  return (
// Change this line in Footer.jsx:
<footer className="w-full border-t border-gray-800 bg-black/60 backdrop-blur-lg pt-12 pb-8 mt-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-12">
          ...
          <div className="flex flex-col space-y-4">
            <h2 className="text-2xl font-bold text-white tracking-wide">
              Study <span className="text-red-600">Ally</span>
            </h2>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><a href="#" className="hover:text-red-400 transition-colors duration-200">Integration Guidelines</a></li>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              App designed and developed by Pallab Mondal, Timothy Utsab Bandyopadhyay & Samrat to help out students in their exam preparation journey.
            </p>
