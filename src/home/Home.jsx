...
const Home = () => {
  ...
  const handleGenerate = async (e, type) => {
   ...
   try {
      if (type === "paper") {
        // --- REAL API CALL WITH PDF UPLOADS ---
        ...
        // Append files if the user uploaded them
        ...
        // 2. Send the FormData (Browser automatically sets correct multipart headers)
        const response = await fetch("/api/paper/generate", {
          method: "POST",
          body: submitData, // DO NOT use JSON.stringify here!
        });
        ...
        // ... (Keep your mock code for quiz and schedule here)
